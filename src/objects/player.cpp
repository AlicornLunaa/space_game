...
void Player::updateKeys(float deltaTime){
    ...
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::A)){ rigidbody->move(-1.f, 0); }
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::D)){ rigidbody->move(1.f, 0); }
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::W)){ rigidbody->move(0, -1.f); }
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::S)){ rigidbody->move(0, 1.f); }
